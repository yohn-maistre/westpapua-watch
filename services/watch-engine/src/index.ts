...
async function current(env:any,url:URL){
  ...
  return {items,lead_reports,pagination:{page,page_size:pageSize,has_more:hasMore,next_page:hasMore?page+1:null},meta:{last_published_at:publication?.latest||null,last_checked:meta?.last_checked||null,articles_total:Number(meta?.articles_total||0)}};
}
