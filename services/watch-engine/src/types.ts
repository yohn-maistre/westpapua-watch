...
export type SourceConfig={id:string;name:string;homepage:string;feed?:string;role:SourceRole;ownership:string;language:string[];scope:'papua'|'mixed';enabled:boolean;resourceCandidate?:boolean;libraryPolicy?:'none'|'selective'|'preferred';priority?:number;notes?:string};
export type DiscoveredItem={sourceId:string;url:string;title:string;publishedAt?:string;publishedAfter?:string};
...
export type StoryPacket={
  ...
  item_type?:string;evidence_roles?:string[];library_worthy?:boolean;library_reason?:string;watch_relevance?:boolean;watch_relevance_confidence?:number;watch_relevance_reason?:string;watch_relevance_evidence?:string[];watch_desk?:WatchDesk;
};
export type IngestMessage={sourceId:string;url:string;title?:string;publishedAt?:string;publishedAfter?:string;force?:boolean};
