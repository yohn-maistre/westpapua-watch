...
export type SourceConfig={id:string;name:string;homepage:string;feed?:string;role:SourceRole;ownership:string;language:string[];scope:'papua'|'mixed';enabled:boolean;resourceCandidate?:boolean;priority?:number;notes?:string};
