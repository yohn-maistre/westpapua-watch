...
async function initOne(root:HTMLElement){
  ...
  function syncControls(){
    ...
    root.querySelectorAll<HTMLButtonElement>('[data-map-view]').forEach(button=>{const on=button.dataset.mapView===activeView;button.hidden=on;button.classList.toggle('active',on);button.setAttribute('aria-pressed',String(on))});
