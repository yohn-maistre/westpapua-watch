...
export const dossiers: Issue[] = [
  ...(following as Issue[]),
  {
    ...
    summary:{en:'Mining permits, operating sites, marine and terrestrial ecosystems, customary land and public scrutiny across Raja Ampat.',pmy:'Izin tambang, lokasi yang masih jalan, ekosistem laut dan darat, tanah adat, dan perhatian publik di Raja Ampat.'},
  ...
  },
  {
    ...
    summary:{en:'Water quality, sedimentation, mining pressure, biodiversity and livelihoods around Lake Sentani and the Cycloop foothills.',pmy:'Kualitas air, sedimentasi, tekanan tambang, keanekaragaman hayati, dan mata pencaharian sekitar Danau Sentani dan kaki Cycloop.'},
  ...
  },
  {
    ...
    title:{en:'South Papua food and energy estate',pmy:'Proyek pangan dan energi Papua Selatan'},
    summary:{en:'Land, forests, livelihoods and the large-scale food and energy projects being developed in and around Merauke.',pmy:'Tanah, hutan, mata pencaharian, dan proyek pangan dan energi skala besar di sekitar Merauke.'},
  ...
  },
  {
    ...
    title:{en:'Conflict, displacement and access',pmy:'Konflik, pengungsian, dan akses'},
    summary:{en:'Civilian displacement, access to services and independent monitoring in conflict-affected areas.',pmy:'Pengungsian warga sipil, akses layanan, dan pemantauan independen di wilayah terdampak konflik.'},
  ...
  },
  {
    ...
    title:{en:'Political status and representation',pmy:'Status politik dan keterwakilan'},
    summary:{en:'The historical political status of the territory, regional institutions, autonomy and Papuan representation.',pmy:'Sejarah status politik wilayah, lembaga daerah, otonomi, dan keterwakilan orang Papua.'},
  ...
  },
  {
    ...
    summary:{en:'Indigenous women’s leadership, rights, land relationships, care, cultural transmission and gender-based violence.',pmy:'Kepemimpinan perempuan adat, hak, hubungan dan tanah, kerja perawatan, pewarisan budaya, dan kekerasan berbasis gender.'},
  ...
  },
  {
    ...
    title:{en:'Culture, memory and expression',pmy:'Budaya, ingatan, dan ekspresi'},
    summary:{en:'Art, literature, film, music and collective practice as living records of Papuan experience and cultural life.',pmy:'Seni, sastra, film, musik, dan kerja kolektif sebagai catatan hidup pengalaman dan budaya Papua.'},
