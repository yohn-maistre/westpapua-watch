...
export const SITE = {
  ...
  description: {
    ...
    pmy: 'Geografi, isu yang masih jalan, perkembangan sekarang, sejarah, acara, pameran, dan sumber soal Papua Barat.'
  } satisfies Localized
};
...
export const PROGRAMME = {
  ...
  title: {
    ...
    pmy: 'Papua Barat dan Maluku di Oceanic Solidarity'
  },
  href: '/events/'
};
