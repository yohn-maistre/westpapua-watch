...
export const issues: Issue[] = [
  {slug:'history-decolonisation',category:'History & decolonisation',title:{en:'History & decolonisation',pmy:'Sejarah & dekolonisasi'},summary:{en:'Archives, historical research and the struggle for self-determination.',pmy:'Arsip, penelitian sejarah, dan perjuangan penentuan nasib sendiri.'},status:{en:'Issue',pmy:'Isu'},updatedAt:'2026-09-10',developmentSlugs:[],sourceIds:[],concepts:[]},
  {slug:'society-culture-religion',category:'Society, culture & religion',title:{en:'Society, culture & religion',pmy:'Masyarakat, budaya & agama'},summary:{en:'Social life, kinship, art, belief and cultural memory.',pmy:'Kehidupan sosial, kekerabatan, seni, kepercayaan, dan ingatan budaya.'},status:{en:'Issue',pmy:'Isu'},updatedAt:'2026-09-10',developmentSlugs:[],sourceIds:[],concepts:[]},
  {
    slug:'land-indigenous-rights',category:'Land & Indigenous rights',
    title:{en:'Land & Indigenous rights',pmy:'Tanah & hak masyarakat adat'},
    summary:{en:'Customary land, tenure, consent, displacement and Indigenous control over territory.',pmy:'Tanah adat, hak atas tanah, persetujuan, penggusuran, dan kendali masyarakat adat atas wilayah.'},
  ...
  },
  {
    ...
    summary:{en:'Mining, plantations, logging, large projects, permits and their social and ecological consequences.',pmy:'Tambang, perkebunan, pembalakan, proyek besar, izin, dan dampak sosial-ekologinya.'},
  ...
  },
  {
    ...
    summary:{en:'Forests, watersheds, reefs, species, protected areas and ecological change across Western New Guinea.',pmy:'Hutan, daerah aliran air, terumbu, spesies, kawasan lindung, dan perubahan ekologi di Papua bagian barat.'},
  ...
  },
  {
    ...
    summary:{en:'Fire, drought, floods, rainfall extremes, landslides and climate-related risks.',pmy:'Kebakaran, kekeringan, banjir, hujan ekstrem, longsor, dan risiko terkait iklim.'},
  ...
  },
  {
    ...
    summary:{en:'Civilian protection, violence, militarization, displacement, detention and access for independent monitoring.',pmy:'Perlindungan warga, kekerasan, militerisasi, pengungsian, penahanan, dan akses pemantauan independen.'},
  ...
  },
  {
    ...
    summary:{en:'Political status, autonomy, institutions, elections, representation and public decision-making.',pmy:'Status politik, otonomi, lembaga, pemilu, keterwakilan, dan pengambilan keputusan publik.'},
  ...
  },
  {
    ...
    summary:{en:'Work, markets, fisheries, agriculture, local enterprise, resource revenue and household livelihoods.',pmy:'Kerja, pasar, perikanan, pertanian, usaha lokal, pendapatan sumber daya, dan mata pencaharian rumah tangga.'},
    status:{en:'Persistent issue',pmy:'Isu jangka panjang'},updatedAt:'2026-09-05',developmentSlugs:[],sourceIds:[],concepts:[]
  },
  {
    ...
    summary:{en:'Health care, nutrition, food systems, water, housing and access to essential public services.',pmy:'Layanan kesehatan, gizi, sistem pangan, air, perumahan, dan akses layanan publik penting.'},
    status:{en:'Persistent issue',pmy:'Isu jangka panjang'},updatedAt:'2026-09-05',developmentSlugs:[],sourceIds:[],concepts:[]
  },
  {
    ...
    summary:{en:'Schools, knowledge, Indigenous languages, cultural transmission, arts, memory and expression.',pmy:'Sekolah, pengetahuan, bahasa adat, pewarisan budaya, seni, ingatan, dan ekspresi.'},
  ...
  },
  {
    ...
    summary:{en:'Women’s leadership, gender-based violence, care, disability, youth and unequal access to rights and services.',pmy:'Kepemimpinan perempuan, kekerasan berbasis gender, perawatan, disabilitas, pemuda, dan ketimpangan akses hak dan layanan.'},
  ...
  },
  {
    ...
    summary:{en:'Roads, ports, aviation, communications, energy systems and unequal physical or digital access.',pmy:'Jalan, pelabuhan, penerbangan, komunikasi, sistem energi, dan ketimpangan akses fisik atau digital.'},
    status:{en:'Persistent issue',pmy:'Isu jangka panjang'},updatedAt:'2026-09-05',developmentSlugs:[],sourceIds:[],concepts:[]
  }
];
