...
export const storyPage:PagesFunction<Env> = async context => {
 const requestUrl=new URL(context.request.url),id=requestUrl.searchParams.get('id'),local=requestUrl.pathname.startsWith('/id/');
